...
public class AliRoleService {
    ...
    public static void main(String[] args) {
        ...
        String accessKeyId = "LTAI4FwSm1WwZ4ZoHca2BcAB";
        String accessKeySecret = "fe8ZZgw03v0YLZ1iddsHkY05jaf3Tw";
        // AssumeRole API 请求参数: RoleArn, RoleSessionName, Policy, and DurationSeconds
        // RoleArn 需要在 RAM 控制台上获取
        String roleArn = "acs:ram::1165752204112719:role/chengxuxiaoba-user"; // 即角色详情页的Arn值
